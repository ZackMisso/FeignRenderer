...
void JsonParser::parse(std::string filename)
{
    ...
    // TODO: is this really the best way to parse the scene files?
    // basically the choice is: do I convolute the parsing process, or convolute
    // the api?
    std::vector<rapidjson::Value*> objects = std::vector<rapidjson::Value*>();
    std::vector<rapidjson::Value*> materials = std::vector<rapidjson::Value*>();
    std::vector<rapidjson::Value*> meshes = std::vector<rapidjson::Value*>();
    rapidjson::Value* camera;
    rapidjson::Value* sampler;
    rapidjson::Value* integrator;
    rapidjson::Value* medium;
