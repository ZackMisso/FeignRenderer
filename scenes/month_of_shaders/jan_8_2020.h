...
static void jan_8_2020()
{
    std::string test_name = "jan_8_2020";
    ...
    for (int i = start_frame; i < end_frame; i++)
    {
        ...
        SimpleMaterialShader::Params shad_params("mesh_mat");

        FeignRenderer::fr_shader("mesh_shad",
                                 "simple_material",
                                 &shad_params);
        ...
        PointEmitter::Params emitter_params(Color3f(700.f, 700.f, 700.f),
                                            origin + Vector3f(0.0, 4.0, 0.0));
