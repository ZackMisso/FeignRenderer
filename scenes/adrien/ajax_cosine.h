...
static void ajax_cosine()
{
    ...
    std::string publish_command = "ffmpeg -r 60 -f image2 -s 1024x1024 -i " + test_name + "/" + test_name + "_%04d.png -vcodec libx264 -crf 25  -pix_fmt yuv420p " + test_name + ".mp4";
    ...
    for (int i = start_frame; i < end_frame; ++i)
    {
        ...
        FeignRenderer::fr_camera("camera",
                                 "perspective",
                                 origin,
                                 Vector3f(-1.24528, 16.2211, -17.5872),
                                 Vector3f(0, 1, 0),
                                 30.f,
                                 1e-4f,
                                 1e4f,
